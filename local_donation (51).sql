...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2026 at 08:10 AM
...
--
-- Table structure for table `pending_donation_items`
--

DROP TABLE IF EXISTS `pending_donation_items`;
CREATE TABLE `pending_donation_items` (
...
--
-- Table structure for table `users_no_index`
--
...
--
-- Indexes for table `pending_donation_items`
--
ALTER TABLE `pending_donation_items`
  ADD PRIMARY KEY (`pending_item_id`),
  ADD KEY `entry_id` (`entry_id`),
  ADD KEY `donor_profile_id` (`donor_profile_id`),
...
--
-- Indexes for table `users_no_index`
--
ALTER TABLE `users_no_index`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `idx_role` (`role`);
...
--
-- AUTO_INCREMENT for table `pending_donation_items`
--
ALTER TABLE `pending_donation_items`
  MODIFY `pending_item_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `users_no_index`
--
ALTER TABLE `users_no_index`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `pending_donation_items`
--
ALTER TABLE `pending_donation_items`
  ADD CONSTRAINT `pending_donation_items_ibfk_1` FOREIGN KEY (`entry_id`) REFERENCES `donation_entries` (`entry_id`),
  ADD CONSTRAINT `pending_donation_items_ibfk_2` FOREIGN KEY (`donor_profile_id`) REFERENCES `profiles` (`profile_id`),
  ADD CONSTRAINT `pending_donation_items_ibfk_3` FOREIGN KEY (`item_id`) REFERENCES `items` (`item_id`);
